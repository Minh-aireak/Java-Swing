...
public class EditLC extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String idLC = txtLcID.getText().trim();
        String idPhim = txtFilmID.getText().trim(); 
        String ngayChieuStr = txtDate.getText().trim();
        String idPhong = (String) cbbRoom.getSelectedItem();
        String soGheStr = txtSeatNum.getText().trim();
        String idGia = txtGiaID.getText().trim();

        if(idLC.isEmpty() || idPhim.isEmpty() || ngayChieuStr.isEmpty() || soGheStr.isEmpty() || idGia.isEmpty()){
        ...
        try {
            ...
            lc.setIdLichChieu(idLC);
            lc.setIdPhim(idPhim);
            lc.setIdPhongChieu(idPhong);
            lc.setIdGia(idGia);

            lc.setSoGheConLai(Integer.parseInt(soGheStr));
            ...
            if (response.getMessage().toLowerCase().contains("thành công") || response.getMessage().toLowerCase().contains("success")) {
                ...
                JOptionPane.showMessageDialog(this, "Cập nhật thất bại: " + response.getMessage());
            }

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Số ghế phải là số nguyên!");
        } catch (java.time.format.DateTimeParseException e) {
            JOptionPane.showMessageDialog(this, "Ngày giờ phải đúng định dạng dd/MM/yyyy HH:mm");
        } catch (Exception e) {
