...
public class PhimDAO {
    ...
    // Thêm phim mới vào CSDL
    public static boolean themPhim(Phim phim) throws FileNotFoundException {
    ...
    public static boolean capNhatPhim(Phim phim) {
        Connection conn = DBConnection.KetNoi();
        if (conn == null) return false;
    ...
    // Xóa phim khỏi CSDL
    public static boolean xoaPhim(String idPhim) {
        Connection conn = DBConnection.KetNoi();
        if (conn == null) return false;
    ...
    private static String layIdTheLoaiTuTen(String ten, Connection conn) {
    ...
    private static boolean phimDangCoLichChieu(String idPhim, Connection conn) {
