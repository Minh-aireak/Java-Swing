...
CREATE TABLE `bill` (
  ...
  CONSTRAINT `FK_DV_TK` FOREIGN KEY (`idTaiKhoan`) REFERENCES `tai_khoan` (`idTaiKhoan`)
...
INSERT INTO `bill` VALUES ('Bill001','KH0001','2025-06-09 01:20:27',580000),('Bill002','KH0001','2025-06-09 01:21:17',410000),('Bill003','KH0002','2025-06-09 01:22:57',580000),('Bill004','KH0002','2025-06-09 01:23:39',260000);
...
INSERT INTO `lich_chieu` VALUES ('LC_250610_01','2025-06-10 16:00:00',27,'P001','PC001','Gia01'),('LC_250610_02','2025-06-10 16:05:00',30,'P002','PC002','Gia01'),('LC_250610_03','2025-06-10 16:10:00',30,'P003','PC003','Gia02'),('LC_250610_04','2025-06-10 16:30:00',27,'P004','PC004','Gia03'),('LC_250610_05','2025-06-10 20:00:00',30,'P001','PC004','Gia02'),('LC_250610_06','2025-06-10 21:00:00',30,'P002','PC003','Gia03'),('LC_250611_01','2025-06-11 08:00:00',27,'P003','PC002','Gia01'),('LC_250611_02','2025-06-11 09:00:00',30,'P004','PC001','Gia02'),('LC_250611_03','2025-06-11 09:30:00',27,'P002','PC004','Gia03'),('LC_250611_04','2025-06-11 13:00:00',30,'P001','PC002','Gia03'),('LC_250611_05','2025-06-11 15:00:00',30,'P002','PC001','Gia03'),('LC_250611_06','2025-06-11 20:00:00',30,'P003','PC004','Gia02');
...
CREATE TABLE `lichchieu_ghe` (
  ...
  `trangThai` enum('Còn trống','Đã đặt') NOT NULL DEFAULT 'Còn trống',
...
INSERT INTO `lichchieu_ghe` VALUES ('LC_250610_01','A6','Đã đặt'),('LC_250610_01','B5','Đã đặt'),('LC_250610_01','D3','Đã đặt'),('LC_250610_04','B5','Đã đặt'),('LC_250610_04','C5','Đã đặt'),('LC_250610_04','D2','Đã đặt'),('LC_250611_01','B5','Đã đặt'),('LC_250611_01','B7','Đã đặt'),('LC_250611_01','C7','Đã đặt'),('LC_250611_03','B3','Đã đặt'),('LC_250611_03','C3','Đã đặt'),('LC_250611_03','D1','Đã đặt');
...
INSERT INTO `tai_khoan` VALUES ('AD0001','0966281026','vuonghung123456789@gmail.com','Hung2005!!','Trịnh Vương','Hưng','2005-06-06','Nghệ An','Nữ'),('AD0002','0987654321','tienanh123456789@gmail.com','Anh2005!','Nguyễn Tiến','Anh','2005-09-20','Hà Nội','Nam'),('KH0001','0865788519','tuanminh18122005@gmail.com','Minh2005@','Nguyễn Tuấn','Aireak','2005-12-18','Hòa Bình','Nam'),('KH0002','0123456789','duylong123456789@gmail.com','Long2005!','Lê Duy ','Long','2005-07-15','Thái Bình','Nam');
...
-- Dump completed on 2025-06-09  2:14:21
